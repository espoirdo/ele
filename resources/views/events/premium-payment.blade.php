...
@section('title', 'Paiement des options premium - ELEDJI')
    ...
    <div class="payment-container">
        <div class="payment-card" x-data="{ methode: '' }">
            ...
            <div class="payment-header">
                ...
                <p style="font-size: 14px; color: var(--texte-doux); margin: 0;">Finalisez le paiement de vos options</p>
            </div>
            ...
            <div class="options-summary">
                <h3 class="options-summary-title">Options sélectionnées</h3>
                @foreach($optionsDetails as $option)
                    <div class="option-item">
                        <span class="option-label">{{ $option['label'] }}</span>
                        <span class="option-price">{{ number_format($option['prix'], 0, ',', ' ') }} FCA</span>
                    </div>
                @endforeach
            </div>

            <div class="payment-total">
                <p class="payment-total-label">Total à payer</p>
                <p class="payment-total-amount">{{ number_format($premiumPayment['total'], 0, ',', ' ') }} FCA</p>
            </div>

            <form action="{{ route('premium.payment.process') }}" method="POST">
                @csrf
